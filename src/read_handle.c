...
int handle__packet(struct dimq *context)
{
	...
	if(context->protocol == dimq_p_mqtt5){
		if(rc == dimq_ERR_PROTOCOL || rc == dimq_ERR_DUPLICATE_PROPERTY){
