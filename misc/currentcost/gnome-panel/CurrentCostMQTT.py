...
class CurrentCostMQTT(gnomeapplet.Applet):
    def on_message(self, dimq, obj, msg):
    ...
    def __init__(self, applet, iid):
        ...
        self.dimq = dimq.dimq()
        self.dimq.on_message = self.on_message
        self.dimq.connect("localhost")
        self.dimq.loop_start()
        self.dimq.subscribe("sensors/cc128/ch1", 0)
