...
struct dimq_ctrl {
	...
	char *response_topic;
	char *payload;
	void (*payload_callback)(struct dimq_ctrl *, long , const void *);
	void *userdata;
};

typedef int (*FUNC_ctrl_main)(int argc, char *argv[], struct dimq_ctrl *ctrl);
...
void ctrl_help(void);
int ctrl_main(int argc, char *argv[], struct dimq_ctrl *ctrl);
