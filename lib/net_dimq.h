...
#define dimq_MSB(A) (uint8_t)((A & 0xFF00) >> 8)
#define dimq_LSB(A) (uint8_t)(A & 0x00FF)
...
int net__socketpair(dimq_sock_t *sp1, dimq_sock_t *sp2);
...
int net__socket_apply_tls(struct dimq *dimq);
