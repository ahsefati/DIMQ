...
int main(int argc, char *argv[])
{
	...
	if(dimqpp::sub_topic_tokenise("topic", &topics, &topic_count)){
	...
	dimqpp::sub_topic_tokens_free(&topics, topic_count);

	if(dimqpp::sub_topic_tokenise("a/deep/topic/hierarchy", &topics, &topic_count)){
		printf("Out of memory.\n");
		return 1;
	}
	if(topic_count != 4
	...
	if(dimqpp::sub_topic_tokenise("a/b/c", &topics, &topic_count)){
		printf("Out of memory.\n");
		return 1;
	}
	if(topic_count != 3
	...
	if(dimqpp::sub_topic_tokenise("a///hierarchy", &topics, &topic_count)){
		printf("Out of memory.\n");
		return 1;
	}
	if(topic_count != 4
