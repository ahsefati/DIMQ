...
def len_test(test, pubrec_packet, pubcomp_packet):
    ...
    mid = 1
    publish_packet = dimq_test.gen_publish("pub/qos2/test", qos=2, mid=mid, payload="message", proto_ver=5)
    ...
    try:
        ...
        dimq_test.do_receive_send(conn, publish_packet, pubrec_packet, "publish")
        dimq_test.do_receive_send(conn, pubrel_packet, pubcomp_packet, "pubrel")
