...
keepalive = 60
server_keepalive = 4
connect_packet = dimq_test.gen_connect("01-server-keepalive-pingreq", keepalive=keepalive, proto_ver=5)
...
pingresp_packet = dimq_test.gen_pingresp()
...
try:
    ...
    dimq_test.expect_packet(conn, "pingreq", pingreq_packet)
    time.sleep(1.0)
