...
mid = 1
subscribe_packet = dimq_test.gen_subscribe(mid, "unsubscribe/test", 2, proto_ver=5)
suback_packet = dimq_test.gen_suback(mid, 2, proto_ver=5)

mid = 2
unsubscribe_packet = dimq_test.gen_unsubscribe_multiple(mid, ["unsubscribe/test", "no-sub"], proto_ver=5)
unsuback_packet = dimq_test.gen_unsuback(mid, reason_code=[0, 17], proto_ver=5)
