...
publish_packet = dimq_test.gen_publish("prop/test", qos=0, payload="message", proto_ver=5, properties=props)
...
try:
    ...
    dimq_test.do_send_receive(conn, publish_packet, ok_packet, "ok")
    rc = 0
