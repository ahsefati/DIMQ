...
rc = 1
keepalive = 60
connect_packet = dimq_test.gen_connect("publish-qos0-test", keepalive=keepalive, proto_ver=5)
...
bad_publish_packet = dimq_test.gen_publish("pub/test", qos=0, payload="0123456789012345678", proto_ver=5)
publish_packet = dimq_test.gen_publish("pub/test", qos=0, payload="012345678901234567", proto_ver=5)
