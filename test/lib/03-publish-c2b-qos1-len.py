...
def len_test(test, puback_packet):
    ...
    mid = 1
    publish_packet = dimq_test.gen_publish("pub/qos1/test", qos=1, mid=mid, payload="message", proto_ver=5)
    ...
    try:
        ...
        dimq_test.do_receive_send(conn, publish_packet, puback_packet, "publish")
