...
mid = 1
publish_1_packet = dimq_test.gen_publish("maximum/qos/qos1", qos=1, mid=mid, payload="message", proto_ver=5)
puback_1_packet = dimq_test.gen_puback(mid, proto_ver=5)

publish_2_packet = dimq_test.gen_publish("maximum/qos/qos0", qos=0, payload="message", proto_ver=5)
...
try:
    ...
    dimq_test.do_receive_send(conn, publish_1_packet, puback_1_packet, "publish 1")
