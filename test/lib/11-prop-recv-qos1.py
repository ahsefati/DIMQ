...
publish_packet = dimq_test.gen_publish("prop/test", mid=mid, qos=1, payload="message", proto_ver=5, properties=props)
puback_packet = dimq_test.gen_puback(mid=mid, proto_ver=5)
