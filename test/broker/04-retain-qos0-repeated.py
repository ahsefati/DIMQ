...
def do_test(proto_ver):
    ...
    keepalive = 60
    mid = 16
    connect_packet = dimq_test.gen_connect("retain-qos0-rep-test", keepalive=keepalive, proto_ver=proto_ver)
    ...
    unsub_mid = 13
    unsubscribe_packet = dimq_test.gen_unsubscribe(unsub_mid, "retain/qos0/test", proto_ver=proto_ver)
    unsuback_packet = dimq_test.gen_unsuback(unsub_mid, proto_ver=proto_ver)
