...
rc = 1
keepalive = 10
connect_packet = dimq_test.gen_connect("msg-param-test", keepalive=keepalive)
connack_packet = dimq_test.gen_connack(rc=0)

mid = 2
subscribe_packet = dimq_test.gen_subscribe(mid, "param/topic", 1)
suback_packet = dimq_test.gen_suback(mid, 1)

mid = 3
publish_packet = dimq_test.gen_publish(topic="param/topic", qos=1, payload="payload contents", retain=1, mid=mid)
puback_packet = dimq_test.gen_puback(mid)

mid = 1
publish_packet_recv = dimq_test.gen_publish(topic="param/topic", qos=1, payload="payload contents", retain=0, mid=mid)
...
try:
    ...
    dimq_test.receive_unordered(sock, puback_packet, publish_packet_recv, "puback/publish_receive")
