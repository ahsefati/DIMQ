...
client_connect_packet = dimq_test.gen_connect("cid", keepalive=keepalive, username="user_one", password="password")
client_connack_packet1 = dimq_test.gen_connack(rc=5)
client_connack_packet2 = dimq_test.gen_connack(rc=0)
...
try:
    ...
    client_sock = dimq_test.do_client_connect(client_connect_packet, client_connack_packet1, timeout=5, port=port)
    ...
    client_sock = dimq_test.do_client_connect(client_connect_packet, client_connack_packet2, timeout=5, port=port)
    client_sock.close()
