...
def do_test(proto_ver):
    ...
    mid = 20
    publish2_packet = dimq_test.gen_publish("bridge/disconnect/test", qos=1, mid=mid, payload="disconnect-message", proto_ver=proto_ver)
    ...
    try:
        ...
        dimq_test.expect_packet(bridge, "puback", puback2_packet)
        rc = 0
