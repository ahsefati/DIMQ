...
def do_test(port, connack_rc, username, password):
    rc = 1
    keepalive = 60
    connect_packet = dimq_test.gen_connect("username-password-check", keepalive=keepalive, username=username, password=password)
    connack_packet = dimq_test.gen_connack(rc=connack_rc)
