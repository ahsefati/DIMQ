...
def do_test(plugin_ver):
    ...
    rc = 1
    keepalive = 10
    connect_packet = dimq_test.gen_connect("connect-uname-pwd-test", keepalive=keepalive, username="readonly")
    ...
    mid_fail = 54
    subscribe_packet_fail = dimq_test.gen_subscribe(mid_fail, "#", 0)
    suback_packet_fail = dimq_test.gen_suback(mid_fail, 0x80)
    ...
    try:
        ...
        dimq_test.do_send_receive(sock, subscribe_packet_fail, suback_packet_fail, "suback")
