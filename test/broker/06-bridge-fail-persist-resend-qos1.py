...
def do_test(proto_ver):
    ...
    rc = 1
    keepalive = 60
    connect_packet = dimq_test.gen_connect("bridge-u-test", keepalive=keepalive, proto_ver=proto_ver)
    connack_packet = dimq_test.gen_connack(rc=0, proto_ver=proto_ver)

    mid = 180
    mid_unknown = 2000

    publish_packet = dimq_test.gen_publish("bridge/unknown/qos1", qos=1, payload="bridge-message", mid=mid, proto_ver=proto_ver)
    puback_packet = dimq_test.gen_puback(mid, proto_ver=proto_ver)
    puback_packet_unknown = dimq_test.gen_puback(mid_unknown, proto_ver=proto_ver)
