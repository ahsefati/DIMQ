...
def do_test(proto_ver):
    ...
    rc = 1
    keepalive = 60
    connect_packet = dimq_test.gen_connect("pub-qos2-test", keepalive=keepalive, proto_ver=proto_ver)
    ...
    mid = 312
    publish_packet = dimq_test.gen_publish("pub/qos2/test", qos=2, mid=mid, payload="message", proto_ver=proto_ver)
