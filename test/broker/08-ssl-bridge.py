...
connect_packet = dimq_test.gen_connect(client_id, keepalive=keepalive, clean_session=False, proto_ver=128+4)
connack_packet = dimq_test.gen_connack(rc=0)

mid = 1
subscribe_packet = dimq_test.gen_subscribe(mid, "bridge/#", 0)
