...
# MQTT 5
# https://github.com/eclipse/dimq/issues/1401
...
mid = 1
connect1_packet = dimq_test.gen_connect("will-test", keepalive=keepalive, proto_ver=5)
...
connect2_packet = dimq_test.gen_connect("will-helper", keepalive=keepalive, proto_ver=5, properties=connect_props, will_topic="will/test", will_payload=b"will delay", will_qos=2, will_properties=will_props)
...
try:
    ...
    sock2 = dimq_test.do_client_connect(connect2_packet, connack2_packet, timeout=30, port=port, connack_error="connack2")
    time.sleep(1)
    sock2.close()
