...
def do_test(proto_ver):
    ...
    try:
        ...
        dimq_test.expect_packet(bridge, "pubrec", pubrec_packet)
        ...
        dimq_test.expect_packet(bridge, "2nd pubrec", pubrec_packet)
        bridge.send(pubrel_packet)

        dimq_test.expect_packet(bridge, "pubcomp", pubcomp_packet)
        rc = 0
