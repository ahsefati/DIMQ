...
static void bad_add_byte_helper(int identifier)
{
	...
	rc = dimq_property_add_byte(&proplist, identifier, 1);
...
static void bad_add_int16_helper(int identifier)
{
	...
	rc = dimq_property_add_int16(&proplist, identifier, 1);
	CU_ASSERT_EQUAL(rc, dimq_ERR_INVAL);
	CU_ASSERT_PTR_NULL(proplist);
}
...
static void bad_add_int32_helper(int identifier)
{
	...
	rc = dimq_property_add_int32(&proplist, identifier, 1);
	CU_ASSERT_EQUAL(rc, dimq_ERR_INVAL);
	CU_ASSERT_PTR_NULL(proplist);
}
...
static void bad_add_varint_helper(int identifier)
{
	...
	rc = dimq_property_add_varint(&proplist, identifier, 1);
	CU_ASSERT_EQUAL(rc, dimq_ERR_INVAL);
	CU_ASSERT_PTR_NULL(proplist);
}
...
static void bad_add_binary_helper(int identifier)
{
	...
	rc = dimq_property_add_binary(&proplist, identifier, "test", 4);
	CU_ASSERT_EQUAL(rc, dimq_ERR_INVAL);
	CU_ASSERT_PTR_NULL(proplist);
}
...
static void bad_add_string_helper(int identifier)
{
	...
	rc = dimq_property_add_string(&proplist, identifier, "test");
	CU_ASSERT_EQUAL(rc, dimq_ERR_INVAL);
	CU_ASSERT_PTR_NULL(proplist);
}
...
static void bad_add_string_pair_helper(int identifier)
{
	...
	rc = dimq_property_add_string_pair(&proplist, identifier, "key", "value");
	CU_ASSERT_EQUAL(rc, dimq_ERR_INVAL);
	CU_ASSERT_PTR_NULL(proplist);
}
...
static void single_add_int16_helper(int identifier)
{
	...
	rc = dimq_property_add_int16(&proplist, identifier, 11234);
	CU_ASSERT_EQUAL(rc, dimq_ERR_SUCCESS);
	CU_ASSERT_PTR_NOT_NULL(proplist);
	if(proplist){
		CU_ASSERT_EQUAL(proplist->identifier, identifier);
...
static void single_add_int32_helper(int identifier)
{
	...
	rc = dimq_property_add_int32(&proplist, identifier, 765432);
	CU_ASSERT_EQUAL(rc, dimq_ERR_SUCCESS);
	CU_ASSERT_PTR_NOT_NULL(proplist);
	if(proplist){
		CU_ASSERT_EQUAL(proplist->identifier, identifier);
...
static void single_add_varint_helper(int identifier)
{
	...
	rc = dimq_property_add_varint(&proplist, identifier, 139123999);
	CU_ASSERT_EQUAL(rc, dimq_ERR_SUCCESS);
	CU_ASSERT_PTR_NOT_NULL(proplist);
	if(proplist){
		CU_ASSERT_EQUAL(proplist->identifier, identifier);
...
static void single_add_string_helper(int identifier)
{
	...
	rc = dimq_property_add_string(&proplist, identifier, "string");
	CU_ASSERT_EQUAL(rc, dimq_ERR_SUCCESS);
	CU_ASSERT_PTR_NOT_NULL(proplist);
	if(proplist){
		CU_ASSERT_EQUAL(proplist->identifier, identifier);
...
static void TEST_add_all_connack(void)
{
	...
	CU_ASSERT_EQUAL(rc, dimq_ERR_SUCCESS);
	CU_ASSERT_PTR_NOT_NULL(proplist);
	rc = dimq_property_add_string(&proplist, MQTT_PROP_ASSIGNED_CLIENT_IDENTIFIER, "clientid");
	CU_ASSERT_EQUAL(rc, dimq_ERR_SUCCESS);
	CU_ASSERT_PTR_NOT_NULL(proplist);
	rc = dimq_property_add_int16(&proplist, MQTT_PROP_SERVER_KEEP_ALIVE, 900);
	CU_ASSERT_EQUAL(rc, dimq_ERR_SUCCESS);
	CU_ASSERT_PTR_NOT_NULL(proplist);
	rc = dimq_property_add_string(&proplist, MQTT_PROP_AUTHENTICATION_METHOD, "basic");
	CU_ASSERT_EQUAL(rc, dimq_ERR_SUCCESS);
	...
	CU_ASSERT_EQUAL(rc, dimq_ERR_SUCCESS);
	CU_ASSERT_PTR_NOT_NULL(proplist);
	rc = dimq_property_add_byte(&proplist, MQTT_PROP_MAXIMUM_QOS, 1);
	CU_ASSERT_EQUAL(rc, dimq_ERR_SUCCESS);
	CU_ASSERT_PTR_NOT_NULL(proplist);
