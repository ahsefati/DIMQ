		...
		uint8_t value_expected)
{
	...
	memset(&packet, 0, sizeof(struct dimq__packet));
...
static void duplicate_byte_helper(int command, uint8_t identifier)
{
	...
	byte_prop_read_helper(command, payload, 5, dimq_ERR_DUPLICATE_PROPERTY, identifier, 1);
}
...
static void bad_byte_helper(int command, uint8_t identifier)
{
	...
	byte_prop_read_helper(command, payload, 3, dimq_ERR_PROTOCOL, identifier, 0);
}
...
static void duplicate_int32_helper(int command, uint8_t identifier)
{
	...
	int32_prop_read_helper(command, payload, 11, dimq_ERR_DUPLICATE_PROPERTY, identifier, 1);
}
...
static void duplicate_int16_helper(int command, uint8_t identifier)
{
	...
	int16_prop_read_helper(command, payload, 7, dimq_ERR_DUPLICATE_PROPERTY, identifier, 1);
}
...
static void duplicate_string_helper(int command, uint8_t identifier)
{
	...
	string_prop_read_helper(command, payload, 9, dimq_ERR_DUPLICATE_PROPERTY, identifier, "");
}
...
static void bad_string_helper(uint8_t identifier)
{
	...
	string_prop_read_helper(CMD_PUBLISH, payload, 7, dimq_ERR_MALFORMED_UTF8, identifier, "");
}
...
static void TEST_truncated(void)
{
	...
	rc = property__read_all(CMD_CONNECT, &packet, &properties);
	CU_ASSERT_EQUAL(rc, dimq_ERR_MALFORMED_PACKET);
	CU_ASSERT_PTR_EQUAL(properties, NULL);
...
static void TEST_single_payload_format_indicator(void)
{
	...
	byte_prop_read_helper(CMD_PUBLISH, payload, 3, dimq_ERR_SUCCESS, MQTT_PROP_PAYLOAD_FORMAT_INDICATOR, 1);
}
...
static void TEST_single_request_problem_information(void)
{
	...
	byte_prop_read_helper(CMD_CONNECT, payload, 3, dimq_ERR_SUCCESS, MQTT_PROP_REQUEST_PROBLEM_INFORMATION, 1);
}
...
static void TEST_single_request_response_information(void)
{
	...
	byte_prop_read_helper(CMD_CONNECT, payload, 3, dimq_ERR_SUCCESS, MQTT_PROP_REQUEST_RESPONSE_INFORMATION, 1);
}
...
static void TEST_single_maximum_qos(void)
{
	...
	byte_prop_read_helper(CMD_CONNACK, payload, 3, dimq_ERR_SUCCESS, MQTT_PROP_MAXIMUM_QOS, 1);
}
...
static void TEST_single_retain_available(void)
{
	...
	byte_prop_read_helper(CMD_CONNACK, payload, 3, dimq_ERR_SUCCESS, MQTT_PROP_RETAIN_AVAILABLE, 1);
}
...
static void TEST_single_wildcard_subscription_available(void)
{
	...
	byte_prop_read_helper(CMD_CONNACK, payload, 3, dimq_ERR_SUCCESS, MQTT_PROP_WILDCARD_SUB_AVAILABLE, 0);
}
...
static void TEST_single_subscription_identifier_available(void)
{
	...
	byte_prop_read_helper(CMD_CONNACK, payload, 3, dimq_ERR_SUCCESS, MQTT_PROP_SUBSCRIPTION_ID_AVAILABLE, 0);
}
...
static void TEST_single_shared_subscription_available(void)
{
	...
	byte_prop_read_helper(CMD_CONNACK, payload, 3, dimq_ERR_SUCCESS, MQTT_PROP_SHARED_SUB_AVAILABLE, 1);
}
...
static void TEST_single_message_expiry_interval(void)
{
	...
	int32_prop_read_helper(CMD_WILL, payload, 6, dimq_ERR_SUCCESS, MQTT_PROP_MESSAGE_EXPIRY_INTERVAL, 0x12233445);
}
...
static void TEST_single_session_expiry_interval(void)
{
	...
	int32_prop_read_helper(CMD_CONNACK, payload, 6, dimq_ERR_SUCCESS, MQTT_PROP_SESSION_EXPIRY_INTERVAL, 0x45342312);
}
...
static void TEST_single_will_delay_interval(void)
{
	...
	int32_prop_read_helper(CMD_WILL, payload, 6, dimq_ERR_SUCCESS, MQTT_PROP_WILL_DELAY_INTERVAL, 0x45342312);
}
...
static void TEST_single_maximum_packet_size(void)
{
	...
	int32_prop_read_helper(CMD_CONNECT, payload, 6, dimq_ERR_SUCCESS, MQTT_PROP_MAXIMUM_PACKET_SIZE, 0x45342312);
}
...
static void TEST_single_server_keep_alive(void)
{
	...
	int16_prop_read_helper(CMD_CONNACK, payload, 4, dimq_ERR_SUCCESS, MQTT_PROP_SERVER_KEEP_ALIVE, 0x4534);
}
...
static void TEST_single_receive_maximum(void)
{
	...
	int16_prop_read_helper(CMD_CONNACK, payload, 4, dimq_ERR_SUCCESS, MQTT_PROP_RECEIVE_MAXIMUM, 0x6842);
}
...
static void TEST_single_topic_alias_maximum(void)
{
	...
	int16_prop_read_helper(CMD_CONNECT, payload, 4, dimq_ERR_SUCCESS, MQTT_PROP_TOPIC_ALIAS_MAXIMUM, 0x6842);
}
...
static void TEST_single_topic_alias(void)
{
	...
	int16_prop_read_helper(CMD_PUBLISH, payload, 4, dimq_ERR_SUCCESS, MQTT_PROP_TOPIC_ALIAS, 0x6842);
}
...
static void TEST_single_content_type(void)
{
	...
	string_prop_read_helper(CMD_PUBLISH, payload, 9, dimq_ERR_SUCCESS, MQTT_PROP_CONTENT_TYPE, "hello");
}
...
static void TEST_single_response_topic(void)
{
	...
	string_prop_read_helper(CMD_WILL, payload, 9, dimq_ERR_SUCCESS, MQTT_PROP_RESPONSE_TOPIC, "hello");
}
...
static void TEST_single_assigned_client_identifier(void)
{
	...
	string_prop_read_helper(CMD_CONNACK, payload, 9, dimq_ERR_SUCCESS, MQTT_PROP_ASSIGNED_CLIENT_IDENTIFIER, "hello");
}
...
static void TEST_single_authentication_method(void)
{
	...
	string_prop_read_helper(CMD_AUTH, payload, 9, dimq_ERR_SUCCESS, MQTT_PROP_AUTHENTICATION_METHOD, "hello");
}
...
static void TEST_single_response_information(void)
{
	...
	string_prop_read_helper(CMD_CONNACK, payload, 9, dimq_ERR_SUCCESS, MQTT_PROP_RESPONSE_INFORMATION, "hello");
}
...
static void TEST_single_server_reference(void)
{
	...
	string_prop_read_helper(CMD_CONNACK, payload, 9, dimq_ERR_SUCCESS, MQTT_PROP_SERVER_REFERENCE, "hello");
}
...
static void TEST_single_reason_string(void)
{
	...
	string_prop_read_helper(CMD_PUBCOMP, payload, 9, dimq_ERR_SUCCESS, MQTT_PROP_REASON_STRING, "hello");
}
...
static void TEST_single_correlation_data(void)
{
	...
	binary_prop_read_helper(CMD_PUBLISH, payload, 9, dimq_ERR_SUCCESS, MQTT_PROP_CORRELATION_DATA, &payload[4], 5);
}
...
static void TEST_single_authentication_data(void)
{
	...
	binary_prop_read_helper(CMD_CONNECT, payload, 9, dimq_ERR_SUCCESS, MQTT_PROP_AUTHENTICATION_DATA, &payload[4], 5);
}
...
static void TEST_single_user_property(void)
{
	...
	string_pair_prop_read_helper(payload, 10, dimq_ERR_SUCCESS, MQTT_PROP_USER_PROPERTY, "za", "bc", false);
}
...
static void TEST_single_subscription_identifier(void)
{
	...
	payload[2] = 0;
	varint_prop_read_helper(payload, 3, dimq_ERR_SUCCESS, MQTT_PROP_SUBSCRIPTION_IDENTIFIER, 0);

	payload[0] = 2;
	payload[1] = MQTT_PROP_SUBSCRIPTION_IDENTIFIER;
	payload[2] = 0x7F;
	varint_prop_read_helper(payload, 3, dimq_ERR_SUCCESS, MQTT_PROP_SUBSCRIPTION_IDENTIFIER, 127);

	payload[0] = 3;
	payload[1] = MQTT_PROP_SUBSCRIPTION_IDENTIFIER;
	payload[2] = 0x80;
	payload[3] = 0x01;
	varint_prop_read_helper(payload, 4, dimq_ERR_SUCCESS, MQTT_PROP_SUBSCRIPTION_IDENTIFIER, 128);

	payload[0] = 3;
	payload[1] = MQTT_PROP_SUBSCRIPTION_IDENTIFIER;
	payload[2] = 0xFF;
	payload[3] = 0x7F;
	varint_prop_read_helper(payload, 4, dimq_ERR_SUCCESS, MQTT_PROP_SUBSCRIPTION_IDENTIFIER, 16383);
	...
	payload[3] = 0x80;
	payload[4] = 0x01;
	varint_prop_read_helper(payload, 5, dimq_ERR_SUCCESS, MQTT_PROP_SUBSCRIPTION_IDENTIFIER, 16384);
	...
	payload[3] = 0xFF;
	payload[4] = 0x7F;
	varint_prop_read_helper(payload, 5, dimq_ERR_SUCCESS, MQTT_PROP_SUBSCRIPTION_IDENTIFIER, 2097151);
	...
	payload[4] = 0x80;
	payload[5] = 0x01;
	varint_prop_read_helper(payload, 6, dimq_ERR_SUCCESS, MQTT_PROP_SUBSCRIPTION_IDENTIFIER, 2097152);
	...
	payload[4] = 0xFF;
	payload[5] = 0x7F;
	varint_prop_read_helper(payload, 6, dimq_ERR_SUCCESS, MQTT_PROP_SUBSCRIPTION_IDENTIFIER, 268435455);
}
...
static void TEST_duplicate_user_property(void)
{
	...
	string_pair_prop_read_helper(payload, 19, dimq_ERR_SUCCESS, MQTT_PROP_USER_PROPERTY, "ab", "gh", true);
}
...
static void TEST_duplicate_subscription_identifier(void)
{
	...
	varint_prop_read_helper(payload, 5, dimq_ERR_MALFORMED_PACKET, MQTT_PROP_SUBSCRIPTION_IDENTIFIER, 0);
}
...
static void TEST_bad_maximum_packet_size(void)
{
	...
	int32_prop_read_helper(CMD_CONNACK, payload, 6, dimq_ERR_PROTOCOL, MQTT_PROP_MAXIMUM_PACKET_SIZE, 0);
}
...
static void TEST_bad_receive_maximum(void)
{
	...
	int32_prop_read_helper(CMD_CONNECT, payload, 4, dimq_ERR_PROTOCOL, MQTT_PROP_RECEIVE_MAXIMUM, 0);
}
...
static void TEST_bad_topic_alias(void)
{
	...
	int32_prop_read_helper(CMD_PUBLISH, payload, 4, dimq_ERR_PROTOCOL, MQTT_PROP_TOPIC_ALIAS, 0);
}
...
static void TEST_bad_subscription_identifier(void)
{
	...
	varint_prop_read_helper(payload, 7, dimq_ERR_MALFORMED_PACKET, MQTT_PROP_SUBSCRIPTION_IDENTIFIER, 0);
}
